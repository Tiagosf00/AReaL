...
| `multi_reward_method`       | string                                              | `"sum"`               | Method for reducing multi-objective rewards. **Choices:** `sum`, `gdpo`                                                                                                                                                                                                                                                                                                                                                                                      |
| `gdpo_norm`                 | [`NormConfig`](section-norm) \| None                | `None`                | Normalization configuration for each reward objective in GDPO.                                                                                                                                                                                                                                                                                                                                                                                                |
...
| `gdpo_weights`              | list of float                                       | `[]`                  | Optional per-objective weights for GDPO aggregation. Empty means all ones. Ignored in `multi_reward_method=sum`.                                                                                                                                                                                                                                                                                                                                             |
