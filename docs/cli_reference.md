...
| `multi_reward_norm`         | [`NormConfig`](section-norm) \| None                | `None`                | Normalization configuration for each reward objective before weighted aggregation.                                                                                                                                                                                                                                                                                                                                                                            |
...
| `gdpo_weights`              | list of float                                       | `[]`                  | Optional per-objective weights for GDPO aggregation. Empty means all ones.                                                                                                                                                                                                                                                                                                                                                                                   |
